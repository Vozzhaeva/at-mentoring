...
public class Task4 {
     ...
     */
    @Test
    public void NewPasteCreate() throws InterruptedException {
        ...
        By priceSelector = By.xpath("//*[@id='resultBlock']/md-card/md-card-content/div/div/div/h2/b");
        String price = findAndClick(priceSelector).getText();
        Assert.assertEquals(actualResult, expectedResult);
        String email = generateEmail();
        By sendEmail = By.xpath("//*[@id='email_quote']");
        findAndClick(sendEmail);
        findAndClick(By.xpath("//*[@id='input_401']")).sendKeys(email);
        findAndClick(By.xpath("//*[@id='dialogContent_407']/form/md-dialog-actions/button[@aria-label='Send Email']"));
        Thread.sleep(3000);
        checkEmailShouldContain(price);
    }

    private void checkEmailShouldContain(String price) {
        driver.switchTo().window(driver.getWindowHandles().toArray()[1].toString());
        findAndClick(By.xpath("//*[@id='mail_messages_content']/div/div[1]/div[3]/span"), 30_000);
        By priceFromEmail = By.xpath("//table/tbody/tr[2]/td[2]/h3");
        WebElement priceFromEmailWebElement = findAndClick(priceFromEmail);
        String text = priceFromEmailWebElement.getText();
        price.contains(text);
    ...
    private WebElement findAndClick(By selector) {
        return findAndClick(selector, 10);
    }

    private WebElement findAndClick(By selector, long waitTime) {
        WebElement element = waitForElementLocatedBy(driver, selector, waitTime);
        element.click();
        return element;
    }
    ...
    private static WebElement waitForElementLocatedBy(WebDriver driver, By by, long timeout) {
    ...
    private static WebElement waitForElementLocatedBy(WebDriver driver, By by) {
        return waitForElementLocatedBy(driver, by, 10);
